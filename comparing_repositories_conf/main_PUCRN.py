...
parser.add_argument('--result_dir', default ="./model/test/result/test", help='result directory')
parser.add_argument('--ckpt', default='./model/release/model.pth', help='model to restore from')
parser.add_argument('--num_point', type=int,  default='256',
                    help='Input Point Number [default: 256]')
parser.add_argument('--num_shape_point', type=int, default='37882',
...
#### PU1K
parser.add_argument('--h5_data', default ='./data/PU1K/train/pu1k_poisson_256_poisson_1024_pc_2500_patch50_addpugan.h5' , help='h5 file for training')
parser.add_argument('--test_data', default = './data/test', help='test data path')
parser.add_argument('--gt_path', default = './data/PU1K/test/input_2048/gt_8192', help='test gt data path')
...
def test(result_dir, net = None, shape_count=2048):
    ...
    for point_path in test_files:
        ...
        fps_end = time.time()
        print(f'fps time: {fps_start - fps_end}s')

...
def parse_pu1k_args():
    ...
    parser.add_argument('--kp_dim', default=32, type=int, help='feature dimension in REM & KGM')
    ...
    parser.add_argument('--in_dim', default=32, type=int, help='input feature dimension of REM & KGM')
    parser.add_argument('--trans_dim', default=32, type=int, help='dim of attention')
